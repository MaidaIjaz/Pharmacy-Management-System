...
$sql=mysqli_query($con, "INSERT INTO cashier(Fname,Lname,address,email, phone_number,username,password)
VALUES('$fname','$lname','$postal','$email','$phone','$user','$pas')");
    ...
    <div class="tabbed_area">  
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				<td><a href="delete_cashier.php?cashierid=<?php echo $row['cashierid']?>"><img src="images/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
		...
		<form name="form1"  onsubmit="return validateForm(validation_script.js);" action="admin_cashier.php" method="post" >
			<table width="220" height="106" border="0" >	
				...
				<tr><td align="center"><input name="phone_number" type="text" style="width:170px"placeholder="Phone"  required="required" id="phone_number" /></td></tr>   
