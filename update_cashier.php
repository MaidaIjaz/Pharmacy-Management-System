...
$sql1 = mysqli_query($con, "UPDATE cashier SET Fname='$fname', Lname='$lname',
address='$postal',email='$email',phone_number='$phone',username='$username', password='$pas' WHERE username='$username'");
if($sql1>0) {header("location:http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/admin_cashier.php");
}else{
